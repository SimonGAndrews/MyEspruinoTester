...
- `test_wifi_module_present.js`: verifies module presence and basic API surface.
- `test_wifi_scan_basic.js`: ensures scan callback executes.
- `test_wifi_api_methods.js`: confirms key methods are exported.
