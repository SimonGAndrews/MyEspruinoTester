...
- Define harness scope around providing Espruino-driven testing with modular flashing adapters (with a focus for flashing on ESP32, ESP32C3, ESP32S3 first) with testing only on a number of espruino boards (Pico, MDBT42Q, WIFI)
- Support Node.js as a comparative “virtual MCU” target.
